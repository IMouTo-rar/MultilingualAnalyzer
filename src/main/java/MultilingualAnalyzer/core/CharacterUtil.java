...
class CharacterUtil {
	...
	public static final int CHAR_LATIN_EXT = 0X00000002;
	...
	static int identifyCharType(char input){
		if(input >= '0' && input <= '9'){
			...
			if (ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS
				...
				return CHAR_OTHER_CJK;
			} else if (ub == Character.UnicodeBlock.LATIN_1_SUPPLEMENT // 扩展拉丁字符
                    // 扩展拉丁字符
                    ...
                    // 印地语
					|| ub == Character.UnicodeBlock.DEVANAGARI) {
				return CHAR_LATIN_EXT;
			}
		}
		//其他的不做处理的字符
